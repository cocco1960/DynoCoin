...
uint256 hashGenesisBlock("0xcc024009470483ae7b2f6d8ff981ffcd9e89fc2639d41f8331b5447035f4eeb8");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(509134573); // DynoCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "DynoCoin Signed Message:\n";
...
{
    // DynoCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // DynoCoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 100000; // DynoCoin: 3.5 days
static const int64 nTargetSpacing = 150; // DynoCoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // DynoCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // DynoCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // DynoCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xe1c2f8b945fbde491a7d627364ee687034ae9bdd9380fe72f4764f483272b0d1");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("f7fdfee1848bce34f790b82a1e659e7da15f1cbd396ade5d7b9a2e724dc65578350845cc3aa6f760942640dd619f644362f8fc588faf56dbb78c4083f0e73ebc9f") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1479638027;
        block.nBits    = 509134573;
        block.nNonce   = 1976758399;

        if (fTestNet)
        {
            block.nTime    = 1479638027;
            block.nNonce   = 324967404;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x3757bd2234298e57d7cd56f43c8573c8b5f8ec6e3efc628c65d1cab1e30c4970"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // DynoCoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("DynoCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("DynoCoinMiner : ProcessBlock, block not accepted");
    }
